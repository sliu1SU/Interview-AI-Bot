...
class InterviewBot:
    ...
    def evaluateOverall(self, codingFeedback, BQFeedback):
        prompt = (
            ...
            "The first three paragraphs of your response should be this. The first paragraph should be the summary of the candidate's overall performance. "
            "The second paragraph should be the coding performance review. The third paragraph should be the behavioral "
